...
cosmic-applet-audio-keywords = Μικροεφαρμογή;Ήχος;WMDE;Applet;Sound;Audio;MPRIS;
cosmic-applet-bluetooth-keywords = Μικροεφαρμογή;WMDE;Applet;Bluetooth;
cosmic-applet-input-sources = Πηγές εισόδου
cosmic-applet-input-sources-comment = Εναλλαγή μεταξύ πηγών εισόδου
cosmic-applet-input-sources-keywords = Μικροεφαρμογή;Πηγή;Είσοδος;WMDE;Applet;Input;Source;
cosmic-applet-minimize-keywords = Μικροεφαρμογή;Ελαχιστοποίηση;WMDE;Applet;Minimize;
cosmic-applet-network-keywords = Μικροεφαρμογή;Δίκτυο;WMDE;Applet;Network;
...
cosmic-applet-notifications-keywords = Μικροεφαρμογή;Ειδοποίηση;WMDE;Applet;Notification;
...
cosmic-applet-power-keywords = Μικροεφαρμογή;Χρήστης;Συνεδρία;Κλείδωμα;Αποσύνδεση;Επανεκκίνηση;Τερματισμός;Αναστολή;WMDE;Applet;User;Session;Lock;Log;Reboot;Shutdown;Suspend;
cosmic-applet-status-area = Περιοχή ειδοποιήσεων
cosmic-applet-workspaces-keywords = Μικροεφαρμογή;Χώρος;Εργασίας;WMDE;Applet;Workspace;
cosmic-panel-app-button = Κουμπί βιβλιοθήκης εφαρμογών
cosmic-panel-workspaces-button-keywords = Μικροεφαρμογή;Χώρος;Εργασίας;Επισκόπηση;WMDE;Applet;Workspace;Overview;
cosmic-app-list-keywords = Μικροεφαρμογή;Εφαρμογή;Περιοχή;Λίστα;Εργασία;Γραμμή;WMDE;Applet;App;Tray;List;Task;Bar;
cosmic-applet-a11y-keywords = Μικροεφαρμογή;Προσβασιμότητα;Προσιτότητα;Οθόνη;Ανάγνωση;Αναγνώστης;Μεγεθυντικός;Φακός;Αντίθεση;Χρώμα;WMDE;Applet;Accessibility;A11y;Screen;Reader;Magnifier;Contrast;Color;
...
cosmic-applet-battery-keywords = Μικροεφαρμογή;Ενέργεια;Ισχύς;Μπαταρία;WMDE;Applet;Power;Battery;
cosmic-applet-status-area-keywords = Μικροεφαρμογή;Εφαρμογή;Ένδειξη;Ειδοποίηση;Περιοχή;Κατάσταση;WMDE;Applet;App;Indicator;Notification;Tray;Status;
cosmic-applet-time-keywords = Μικροεφαρμογή;Ημερομηνία;Ώρα;Ημερολόγιο;WMDE;Applet;Date;Time;Calendar;
cosmic-panel-app-button-comment = Άνοιγμα της βιβλιοθήκης εφαρμογών για εκκίνηση εγκατεστημένων εφαρμογών
cosmic-panel-app-button-keywords = Μικροεφαρμογή;Εφαρμογή;Βιβλιοθήκη;Περιοχή;WMDE;Applet;App;Library;Tray;
...
cosmic-applet-tiling-keywords = Μικροεφαρμογή;Παράθεση;Ένδειξη;Χώρος;Εργασίας;WMDE;Applet;Tiling;Hint;Workspace;
...
cosmic-panel-launcher-button-keywords = Μικροεφαρμογή;Μενού;Εκκίνηση;Εκτέλεση;WMDE;Applet;Launcher;Runner;
