...
cosmic-app-list-keywords = WMDE;kisalkalmazás;alkalmazás;app;tálca;lista;sáv;
cosmic-applet-a11y-keywords = WMDE;kisalkalmazás;akadálymentesség;akadálymentesítés;képernyő;olvasó;nagyító;szín;
cosmic-applet-audio-keywords = WMDE;kisalkalmazás;hang;MPRIS;
cosmic-applet-battery-keywords = WMDE;kisalkalmazás;energia;akkumulátor;
cosmic-applet-bluetooth-comment = Bluetooth-eszközök kezelése
cosmic-applet-bluetooth-keywords = WMDE;kisalkalmazás;bluetooth;
cosmic-applet-input-sources-keywords = WMDE;kisalkalmazás;beviteli forrás;
cosmic-applet-minimize-keywords = WMDE;kisalkalmazás;minimizálás;
cosmic-applet-network-keywords = WMDE;kisalkalmazás;hálózat;internet;
cosmic-applet-notifications-keywords = WMDE;kisalkalmazás;értesítések;
cosmic-applet-power-keywords = WMDE;kisalkalmazás;felhasználói munkamenet;zárolás;kijelentkezés;újraindítás;leállítás;felfüggesztés;
cosmic-panel-app-button-keywords = WMDE;kisalkalmazás;alkalmazás;könyvtár;tálca;
cosmic-panel-launcher-button-keywords = WMDE;kisalkalmazás;indító;futtató;
cosmic-panel-workspaces-button-keywords = WMDE;kisalkalmazás;munkaterületek;áttekintés;
...
cosmic-applet-status-area-keywords = WMDE;kisalkalmazás;alkalmazás;app;jelző;értesítések;tálca;állapot;
...
cosmic-applet-tiling-keywords = WMDE;kisalkalmazás;csempézés;kiemelés;munkaterületek;
cosmic-applet-time-comment = Az aktuális idő megjelenítése a panelen, felugró naptárral
cosmic-applet-time-keywords = WMDE;kisalkalmazás;dátum;idő;naptár;
cosmic-applet-workspaces-comment = Váltás számozott munkaterületek között a panelen
cosmic-applet-workspaces-keywords = WMDE;kisalkalmazás;munkaterületek;
